...
const Card: FC<CardProps> = ({card, ...props}) => {
  ...
  return (
    <Div {...props} className="m-2 rounded-2xl border border-gray-300 shadow-md overflow-hidden max-w-2xl">
      <div className="flex flex-col">
        ...
        <Div className="p-4" height="auto">
          ...
          <p className="mt-2 line-clamp-2">{paragraphs}</p>
          <Div className="flex flex-row items-center justify-between max-h-10 p-2 mt-2 text-red-500">
            {icons}
          </Div>
        </Div>
      </div>
